...
Original file is located at
    https://colab.research.google.com/drive/15XWO5MeMUnpDRfGlfe9YeQk-W6OO1r-4
"""

#intitialize minimum probability to filter weak detections along with
#the threshold when applying non-maxima suppresion
MIN_CONF=0.3
NMS_THRESH=0.3
...
def detect_people(frame, net, ln, personIdx=0):
    ...
    #giving us our bounding boxes andassociated probabilities
    blob = cv2.dnn.blobFromImage(frame, 1/255.0, (416, 416), swapRB=True, crop=False)
    net.setInput(blob)
    layerOutputs=net.forward(ln)
    
    #initialize our lists of detected bounding boxes, centriods, and confidences, respectively
    boxes = []
    centroids = []
    confidences = []
    ...
    for output in layerOutputs:
        ...
        for detection in output:
            ...
            if classID == personIdx and confidence > MIN_CONF:
                ...
                #that YOLO actually returns the center (x,y)-coordinates of the bounding box followed by the
...
while True:
    ...
    for (i, (prob, bbox, centroid)) in enumerate(results):
        #extract the bounding box and centroid coordinates, then initialize thr color of the annotation
    ...
    if args["display"] > 0:
        ...
        #if the q kay was pressed, break from the loop
        if key== ord("q"):
            break
